...
The `calculate_egfr_child` function is to `r get_from_calculations_table("egfr_child", "purpose")`. 

Following is the formula to calculate it: 
```{r echo=FALSE}
htmltools::pre(gsub("  ", "", get_from_calculations_table("egfr_child", "equation")))
```
